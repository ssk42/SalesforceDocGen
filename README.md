...
[![Version](https://img.shields.io/badge/version-1.8.0-blue.svg)](#install)
...
```bash
sf package install --package 04tal000006PFQDAA4 --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tal000006PFQDAA4) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tal000006PFQDAA4)
